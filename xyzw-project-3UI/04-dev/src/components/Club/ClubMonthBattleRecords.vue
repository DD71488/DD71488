    ...
    <div class="club-month-battle-records-card">
      ...
      <div class="header-section">
        ...
        <div class="header-actions">
          <a-radio-group v-model="currentStyle" size="small">
            <a-radio value="default">默认</a-radio>
            <a-radio value="style1">样式一</a-radio>
            <a-radio value="style2">样式二</a-radio>
          </a-radio-group>
          <a-button size="small" :disabled="loading" @click="handleRefresh">
            <template #icon>
...
<IconRefresh />
          ...
          <a-button type="primary" size="small" :disabled="!monthlyBattleRecords || loading" @click="handleExport">
            <template #icon>
...
<IconCopy />
      ...
      <div class="battle-records-content">
            ...
            <div class="monthly-stats-overview">
              <div class="stats-header">
                ...
                <div class="stats-tags">
                  <a-tag type="info">统计日期: {{ currentMonthDisplay }}</a-tag>
                  <a-tag type="warning">总参战成员: {{ monthlyStats.totalMembers }}</a-tag>
                </div>
              </div>
        ...
        <div v-else class="empty-state">
          <a-empty description="暂无战绩数据" size="large">
            <template #icon>
