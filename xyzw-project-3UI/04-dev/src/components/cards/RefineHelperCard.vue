  ...
  <MyCard class="refine-helper" :statusClass="{ active: state.isRunning }">
    ...
    <template #default>
      <div class="refine-container">
        <!-- 工具栏 -->
        <div class="toolbar">
          <a-button type="primary" size="small" @click="refreshHeroes"
            >刷新阵容</a-button
          >
          <a-button size="small" @click="resetCount">清零</a-button>
          <div class="jade-info">
        ...
        <div v-if="selectedPart" class="refine-detail">
          ...
          <div class="password-section">
            ...
            <div class="password-validated" v-else>
              <a-tag type="success" size="small">密码已验证</a-tag>
              <a-button
                type="warning"
                size="small"
