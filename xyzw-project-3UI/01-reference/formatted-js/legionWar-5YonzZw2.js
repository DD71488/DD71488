...
var L = (o, n, i) =>
  n in o
    ? x(o, n, { enumerable: !0, configurable: !0, writable: !0, value: i })
    : (o[n] = i);
...
const H = [
  ...
  p = class p {
    ...
    addNode(n) {
      ...
      this.nodes[i] ||
        ((this.nodes[i] = {
          ...
          point: n.point,
          colorBg:
            ((d = n == null ? void 0 : n.belongsLegionInfo) == null
              ? void 0
              : d.color) || r(n.type),
          typeName: c(n.type),
          position: {
    ...
    buildAdjacency(n) {
      ...
      (i % 2 === 0 ? this.evenQDirs : this.oddQDirs).forEach(
        ({ q: e, r: s }) => {
          const g = `${parseInt(i) + e}_${parseInt(d) + s}`,
            t = this.nodes[g];
          t &&
            (n.neighbors.includes(t) || n.neighbors.push(t),
            t.neighbors.includes(n) || t.neighbors.push(n));
        },
      );
    }
    getNodeByCoords(n) {
