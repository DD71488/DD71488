  ...
  X = {
    ...
    props: {
      entry: {
        type: Object,
        required: !0,
        validator: (t) => t.version && t.date && t.type,
      },
    },
    setup(t) {
      const h = (d) => {
      ...
      return (d, r) => (
        ...
        l("div", M, [
          e("div", R, [
            e(
              "div",
              { class: C(["version-badge", `badge-${t.entry.type}`]) },
              c(t.entry.version),
              3,
            ),
            e("div", W, [
              ...
              e(
                "span",
                { class: C(["type-tag", `tag-${t.entry.type}`]) },
                c(b(t.entry.type)),
                3,
              ),
            ]),
                ...
                l("div", q, [
                  ...
                  e("ul", G, [
                    ...
                    l(
                      ...
                      null,
                      x(
                        t.entry.improvements,
                        (u, i) => (
                          o(),
                          l("li", { key: `improvement-${i}` }, c(u), 1)
                        ),
                      ),
                      128,
                    )),
  ...
  Z = w("changelog", () => {
    const t = T([
      ...
      a = (n, v) => {
        ...
        return f === -1 || _ === -1
          ? []
          : t.value.slice(Math.min(f, _), Math.max(f, _) + 1);
      },
    ...
    setup(t) {
      const h = Z(),
        ...
        u = p(() =>
          b.value === "all"
            ? h.changelogs
            : h.changelogs.filter((g) => g.type === b.value),
        ),
        i = p(() => ({
          ...
          totalImprovements: h.changelogs.reduce((g, s) => {
            var a;
            return (
              g + (((a = s.improvements) == null ? void 0 : a.length) || 0)
            );
          }, 0),
        })),
        m = () => {
          ...
          l("div", ee, [
            e("div", te, [
              ...
              e("div", re, [
                ...
                e("div", ue, [
                  ...
                  e("div", ge, [
                    ...
                    s[5] ||
                      (s[5] = e("div", { class: "stat-label" }, "新功能", -1)),
                  ]),
                ]),
                e("div", he, [
                    ...
                    default: j(() => [
                      ...
                      l(
                        ...
                        x(
                          ...
                          (a) => (
                            o(),
                            L(Y, { key: a.version, entry: a }, null, 8, [
                              "entry",
                            ])
                          ),
                        ),
              ...
              e("div", _e, [
                e("div", $e, [
                  s[13] ||
                    (s[13] = e("div", { class: "subscribe-icon" }, "🔔", -1)),
                  s[14] ||
                    (s[14] = e(
                      "div",
