...
import { K as oo } from "./index-Dnomu2Fp.js";
const lo = {
      ...
      d = () => {
        ...
        if (o.value && e.value) {
          const { top: h, left: B } = o.value.getBoundingClientRect(),
            ...
            C = W - B,
            G = L - h - M;
          (C !== ((O = t.value) == null ? void 0 : O[0]) ||
            G !== ((T = t.value) == null ? void 0 : T[1])) &&
            (t.value = [C, G]);
          const V = H > N ? H - N : 0,
            Y = K > j ? K - j - M : 0;
          ((V !== a.value[0] || Y !== a.value[1]) && (a.value = [V, Y]),
            M && (y.value = [0, 0 - M]));
        }
      },
      v = (i) => {
...
var vo = de({
  ...
  setup(e, { emit: o }) {
    const { fullscreen: n, popupContainer: r, alignCenter: u } = Ae(e),
      ...
      { teleportContainer: i, containerRef: O } = Xe({
        popupContainer: r,
        visible: d,
      }),
      T = f(d.value),
    ...
    const W = (s) => {
      ...
      N = () => {
        e.escToClose &&
          !L &&
          ((L = !0), U(document.documentElement, "keydown", W));
      },
      j = () => {
        ((L = !1), ce(document.documentElement, "keydown", W));
      };
    let M = 0;
    const { position: C, handleMoveDown: G } = fo({
        wrapperRef: p,
        modalRef: y,
        draggable: w,
        alignCenter: u,
      ...
      J = (s) => {
        var S;
        let R = !0;
        (F(e.onBeforeCancel) && (R = (S = e.onBeforeCancel()) != null ? S : !1),
          R && (o("cancel", s), V()));
      },
      q = f(!1),
      Se = (s) => {
      ...
      Te = () => {
        d.value ||
          (w.value && (C.value = void 0), (T.value = !1), ve(), o("close"));
      },
      { setOverflowHidden: fe, resetOverflow: ve } = co(O);
    (Ee(() => {
      ((O.value = Ze(e.popupContainer)),
        d.value && (fe(), e.escToClose && N()));
    }),
      Pe(() => {
        (ve(), j());
      }),
      pe(d, (s) => {
        (a.value !== s && (a.value = s),
          s
            ? (o("beforeOpen"), (T.value = !0), (q.value = !1), fe(), N())
            : (o("beforeClose"), j()));
      }),
      pe(n, () => {
    ...
    const Me = g(() => [
      ...
      ze = g(() => {
        ...
        return (
          e.width &&
            !e.fullscreen &&
            (S.width = ue(e.width) ? `${e.width}px` : e.width),
          !e.alignCenter && e.top && (S.top = ue(e.top) ? `${e.top}px` : e.top),
          C.value &&
            (S.transform = `translate(${C.value[0]}px, ${C.value[1]}px)`),
          S
        );
      });
    return {
                      ...
                      I(
                        "div",
                        {
                          ...
                          onClick:
                            ...
                            (o[2] = Ce(
                              (...i) =>
                                e.handleMaskClick && e.handleMaskClick(...i),
                              ["self"],
                            )),
                          onMousedown:
                            o[3] ||
...
const ie = (e, o) => {
    ...
    const r = () => {
      ...
      l = async () => {
        (await Le(),
          n && (ke(null, n), document.body.removeChild(n)),
          (n = null),
          F(e.onClose) && e.onClose());
      },
      t = () => {
        a.component && (a.component.props.visible = !1);
      },
      ...
      a = P(
        ...
        {
          default: ae(e.content),
          title: ae(e.title),
          footer: typeof e.footer != "boolean" ? ae(e.footer) : void 0,
        },
      );
    return (
  ...
  we = Object.assign(Z, {
    ...
    install: (e, o) => {
      ...
      const r = {};
      for (const u of Object.keys(re))
        r[u] = (l, t = e._context) => re[u](l, t);
