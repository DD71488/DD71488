...
import { u as te } from "./gameRoles-BeNVqtZt.js";
import { _ as le } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { A as ae } from "./Add-DAhPk3tV.js";
import { E as oe } from "./EllipsisHorizontal-eOImISpV.js";
import { P as ne } from "./PersonCircle-BWZS_cvm.js";
import "./localTokenManager-DrgF481l.js";
    ...
    setup(Ue) {
      ...
      const c = L(),
        ...
        G = {
          ...
          server: [
            { required: !0, message: "请选择服务器", trigger: "change" },
          ],
          profession: [
            { required: !0, message: "请选择职业", trigger: "change" },
          ],
          level: [
            {
              required: !0,
        ...
        B = async () => {
          if (k.value)
            try {
              ...
              let t;
              (f.value
                ? (t = await r.updateGameRole(f.value.id, n))
                : (t = await r.addGameRole(n)),
                t.success
                  ? (c.success(t.message), (d.value = !1), M())
                  : c.error(t.message));
            } catch {
            } finally {
              h.value = !1;
                    ...
                    a("div", ce, [
                      l(
                        g,
                        {
                          type: "primary",
                          size: "large",
                          onClick: e[0] || (e[0] = (s) => (d.value = !0)),
                        },
                        {
                          icon: o(() => [
                            l(R, null, { default: o(() => [l(m(ae))]), _: 1 }),
                          ]),
                          default: o(() => [
                            e[10] || (e[10] = _(" 添加角色 ", -1)),
                          ]),
                                ...
                                a("div", pe, [
                                  a("div", _e, [
                                    a(
                                      "img",
                                      {
                                        src: s.avatar || "/icons/xiaoyugan.png",
                                        alt: s.name,
                                      },
                                      null,
                                      8,
