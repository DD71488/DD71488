...
import { u as L } from "./auth-BzVLibGZ.js";
import { _ as M } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { P as N } from "./PersonCircle-BWZS_cvm.js";
        ...
        w = async () => {
          if (v.value)
            try {
              ...
              const a = await _.register({
                username: t.username,
                email: t.email,
                password: t.password,
              });
              a.success
                ? (u.success("注册成功，请登录"), c.push("/login"))
                : u.error(a.message);
            } catch (a) {
                      ...
                      default: r(() => [
                        ...
                        i("div", D, [
                          s(
                            C,
                            {
                              checked: t.agreeTerms,
                              "onUpdate:checked":
                                e[6] || (e[6] = (o) => (t.agreeTerms = o)),
                            },
                            {
                              default: r(() => [
                  ...
                  i("div", E, [
                    ...
                    s(
                      g,
                      {
                        text: "",
                        type: "primary",
                        onClick: e[7] || (e[7] = (o) => f(c).push("/login")),
                      },
                      {
                        default: r(() => [
                          ...(e[13] || (e[13] = [l(" 立即登录 ", -1)])),
