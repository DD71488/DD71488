const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["assets/index-BUwMeHKm.js", "assets/index-DlxoWD7I.css"]),
) => i.map((i) => d[i]);
import {
  x as ge,
  s as be,
...
import { A as Se } from "./AlertCircleOutline-DSz5dGmY.js";
const Oe = { class: "message-tester" },
  ...
  Ee = {
    class:
      "text-sm bg-gray-50 p-2 rounded border max-h-20 overflow-hidden message-preview",
  },
  Ze = { class: "mt-2" },
      ...
      const N = B(null),
        ...
        P = () => {
          ...
          if (e) {
            ...
            try {
              ...
              (console.error("❌ MessageTester: WebSocket连接失败", t),
                u.error("WebSocket连接失败: " + t.message));
            }
        ...
        K = async (e) => {
          const { g_utils: t } = await E(
              async () => {
                const { g_utils: r } = await import("./index-BUwMeHKm.js").then(
                  (i) => i.b4,
                );
                return { g_utils: r };
              },
        ...
        Q = async () => {
          try {
            const { g_utils: e } = await E(
                async () => {
                  const { g_utils: s } =
                    await import("./index-BUwMeHKm.js").then((a) => a.b4);
                  return { g_utils: s };
                },
                __vite__mapDeps([0, 1]),
              ),
            ...
            (console.error("❌ BON解码测试失败:", e),
              ...
              H(
                "test",
                { testType: "BON解码测试", error: e.message, status: "error" },
                "bon_decode_test",
              ));
          }
        },
        H = (e, t, s = null, a = {}) => {
          if (e !== "test" && (s === "_sys/ack" || s === "heartbeat"))
            return null;
          const r = { ...Z(t), ...a },
            i = {
              type: e,
          ...
          return (
            g.value.unshift(i),
            g.value.length > 50 && (g.value = g.value.slice(0, 50)),
            i
          );
        },
        X = () => {
          if (!b.value) return;
          _.sendHeartbeat(f.value)
            ? u.success("心跳消息已发送")
            : u.error("心跳消息发送失败");
        },
        Y = () => {
          ...
          _.sendGetRoleInfo(f.value)
            ? (H("sent", { cmd: "role_getroleinfo" }, "role_getroleinfo"),
              u.success("角色信息请求已发送"))
            : u.error("角色信息请求发送失败");
        },
        ee = () => {
        ...
        te = () => {
          ...
          _.sendGameMessage(f.value, "system_signinreward", {})
            ? (H("sent", { cmd: "system_signinreward" }, "system_signinreward"),
              u.success("签到请求已发送"))
            : u.error("签到请求发送失败");
        },
        se = () => {
              ...
              _.sendGameMessage(f.value, k.value, e, {
                onSent: (r = {}) => {
                  ...
                  (typeof r.seq == "number" && (i.seq = r.seq),
                    ...
                    t
                      ? (t.meta = { ...t.meta, ...i })
                      : Object.keys(i).length > 0 && Object.assign(s, i));
                },
              })
                ? ((t =
                    H("sent", { cmd: k.value, body: e }, k.value, s) || null),
        ...
        j = (e) => {
          var s, a;
          if (!e) return;
          if (((s = e.meta) == null ? void 0 : s.seq) !== void 0)
            return e.meta.seq;
          const t = ((a = e.data) == null ? void 0 : a._raw) || e.data;
          return typeof (t == null ? void 0 : t.seq) == "number"
            ? t.seq
            : void 0;
        },
        T = (e) => {
          var s, a;
          if (!e) return;
          if (((s = e.meta) == null ? void 0 : s.ack) !== void 0)
            return e.meta.ack;
          const t = ((a = e.data) == null ? void 0 : a._raw) || e.data;
          return typeof (t == null ? void 0 : t.ack) == "number"
            ? t.ack
            : void 0;
        },
        ...
        re = (e) => {
          ...
          try {
            ...
            ((t = e._raw) != null && t.decodedBody) || e.decodedBody
              ? (i =
                  ((s = e._raw) == null ? void 0 : s.decodedBody) ||
                  e.decodedBody)
...
${JSON.stringify(e.data, null, 2)}`;
        ...
        q = (e) => {
          ...
          if (typeof e == "object" && e.constructor === Object) {
            ...
            if (t.every((s) => !isNaN(parseInt(s))))
              return `[NumericObject: ${t.length} entries]`;
          }
                      ...
                      n("div", ze, [
                        ...
                        l(
                          y,
                          {
                            ...
                            type: "textarea",
                            placeholder:
                              '消息体 JSON (例如: {"clientVersion": "1.65.3-wx"})',
                            rows: 3,
                            class: "w-full",
                          },
                          null,
