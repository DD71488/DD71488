import { aF as m, r as c } from "./index-BUwMeHKm.js";
import { u as i } from "./localTokenManager-DrgF481l.js";
const G = m("gameRoles", () => {
  const a = c([]),
    o = c(!1),
    l = c(null),
  ...
  return {
    ...
    fetchGameRoles: async () => {
      try {
        ...
        return (
          console.error("获取游戏角色失败:", e),
          { success: !1, message: "本地数据读取失败" }
        );
      } finally {
        o.value = !1;
      }
    ...
    addGameRole: async (e) => {
      try {
        ...
        return (
          n.addGameToken(t, u),
          { success: !0, message: "添加角色成功，已生成游戏token" }
        );
      } catch (t) {
        return (
          console.error("添加游戏角色失败:", t),
          { success: !1, message: "添加角色失败" }
        );
      } finally {
        o.value = !1;
      }
    ...
    updateGameRole: async (e, t) => {
      try {
        ...
        return (
          console.error("更新游戏角色失败:", s),
          { success: !1, message: "更新角色失败" }
        );
      } finally {
        o.value = !1;
      }
    ...
    deleteGameRole: async (e) => {
      try {
        return (
          ...
          l.value &&
            l.value.id === e &&
            ((l.value = null), localStorage.removeItem("selectedRole")),
          { success: !0, message: "删除角色成功，已清理相关token" }
        );
      } catch (t) {
        return (
          console.error("删除游戏角色失败:", t),
          { success: !1, message: "删除角色失败" }
        );
      } finally {
        o.value = !1;
      }
    ...
    selectRole: (e) => {
      ...
      if (t && t.token)
        try {
          (n.createWebSocketConnection(e.id, t.token, t.wsUrl),
            console.log(`已为角色 ${e.name} 建立WebSocket连接`));
        } catch (s) {
