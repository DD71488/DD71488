import { _ as Ae } from "./ServerRoleList-K5eSJYby.js";
import {
  k as F,
  c as N,
  a as l,
...
import { L as Ye, a as Ze } from "./index-Dne5XMpP.js";
import { C as $e } from "./CloudUpload-CqW5D9SP.js";
import { R as et } from "./Refresh-Cb4iOY7D.js";
      ...
      const S = De(),
        ...
        he = async (e) => {
          ...
          try {
            ...
            (console.error("添加角色失败", t),
              f.error("添加角色失败: " + t.message));
          }
        },
        $ = async () => {
          try {
          ...
          try {
            ...
            if ((y || x) && T && y) {
              ...
              if (
                ...
                throw (
                  console.error("微信返回浏览器不支持错误,尝试切换代理"),
                  new Error("BROWSER_NOT_SUPPORTED")
                );
            }
            let i =
              (e = new DOMParser()
                .parseFromString(o, "text/html")
                .querySelector("img.auth_qrcode")) == null
                ? void 0
                : e.src;
            if (!i) {
        ...
        ke = async (e, t = "") => {
          try {
            ...
            (w("处理失败：" + o.message, "error"),
              console.error("扫码处理失败:", o));
          } finally {
            I.value = !1;
          }
        },
        ...
        ee = (e) => {
          ...
          console.log(
            "codeBase64:",
            (n == null ? void 0 : n.substring(0, 100)) + "...",
          );
          const s = te(n);
          return (
            console.log("编码结果长度:", s == null ? void 0 : s.length),
            s
          );
        },
        Se = (e) => {
        ...
        Ee = (e) =>
          e.length % 2 !== 0 ? null : e.substring(Math.floor(e.length / 2)),
        Ie = (e) =>
          e.length % 2 !== 0 ? null : e.substring(0, Math.floor(e.length / 2)),
        ne = (e, t) => {
          const o = e.split(""),
            a = [],
          ...
          for (let r = 0; r < a.length; r++)
            (s >= i.length && (s = 0),
              (n[r] = String.fromCharCode(
                a[r].charCodeAt(0) ^ i[s].charCodeAt(0),
              )),
              s++);
          return n.join("");
        },
        qe = async (e, t = "") => {
          ...
          try {
            ...
            (console.error("Failed to get server list", n),
              f.warning("获取服务器角色列表失败"),
              (H.value = []));
          }
          try {
            ...
            (!s &&
              n._raw &&
              (console.log("Bin文件 getData() 为空，尝试使用_raw"),
              (s = { ...n._raw })),
              console.log("Bin文件解析:", s),
              (Z.value = JSON.stringify(s, null, 2)),
              (A.value = s));
          } catch (n) {
            (console.error("Bin文件解析失败", n),
              (Z.value = "Bin文件解析失败: " + (n.message || n)));
          }
        },
        Ne = async () => {
          if (b.value.length === 0) {
          ...
          (b.value.forEach((e) => {
            ...
            t
              ? (console.log("更新同名token:", t),
                S.updateToken(t.id, { ...e }))
              : S.addToken({ ...e });
          }),
        ...
        Ce = (e, t) => {
          const o = new Blob([new Uint8Array(t)], {
            ...
            N("div", mt, [
              l("div", ft, [
                u(
                  ...
                  {
                    icon: d(() => [
                      u(m(V), null, { default: d(() => [u(m($e))]), _: 1 }),
                    ]),
                ...
                u(
                  ...
                  {
                    block: "",
                    onClick: t[0] || (t[0] = (n) => e.$emit("cancel")),
                    disabled: I.value,
                  },
                  {
                    icon: d(() => [
                      u(m(V), null, { default: d(() => [u(m(rt))]), _: 1 }),
                    ]),
                  ...
                  : (R(),
                    N(
                      ...
                      [
                        u(
                          m(V),
                          { size: "48", color: "var(--text-tertiary)" },
                          { default: d(() => [u(m(pt))]), _: 1 },
                        ),
                        t[4] ||
                          (t[4] = l("p", null, "点击获取微信登录二维码", -1)),
                      ],
                    )),
                l(
                  "div",
                  { id: "qr-status", class: Ve(["qr-status", Q.value]) },
                  q(K.value),
                  3,
                ),
              ]),
              l("div", ht, [
                u(
                  ...
                  {
                    icon: d(() => [
                      u(m(V), null, { default: d(() => [u(m(et))]), _: 1 }),
                    ]),
                    default: d(() => [
                      v(" " + q(U.value ? "刷新二维码" : "获取二维码"), 1),
                    ]),
                    _: 1,
                  },
                  8,
                          ...
                          { key: s },
                          {
                            default: d(() => [
                              l("div", vt, [
                                l("div", null, [
                                  t[6] ||
                                    (t[6] = l("strong", null, "角色名称:", -1)),
                                  v(" " + q(n.name || "未命名角色"), 1),
                                  t[7] || (t[7] = l("br", null, null, -1)),
                                  t[8] ||
                                    (t[8] = l("strong", null, "Token:", -1)),
                                  l("span", xt, q(n.token), 1),
                                  t[9] || (t[9] = l("br", null, null, -1)),
                                  t[10] ||
                                    (t[10] = l("strong", null, "服务器:", -1)),
                                  v(" " + q(n.server || "未指定"), 1),
