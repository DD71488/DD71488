  ...
  setup(e, { emit: t, slots: n, attrs: i }) {
    ...
    const I = L(!1),
      ...
      he = u(
        () =>
          h.value ||
          !!(P(e.maxLength) && e.maxLength.errorOnly && U.value > C.value),
      ),
      ...
      le = (l) => {
        ...
        (C.value &&
          ...
          F(l) > C.value &&
          (l =
            (y = (d = e.wordSlice) == null ? void 0 : d.call(e, l, C.value)) !=
            null
              ? y
              : l.slice(0, Me.value)),
          (V.value = l),
      ...
      Pe = (l) => {
        v.value &&
          l.target !== v.value &&
          (l.preventDefault(), v.value.focus());
      },
      ie = (l, d) => {
        var y, _;
        l !== M &&
          ((M = l),
          t("change", l, d),
          (_ = (y = m.value) == null ? void 0 : y.onChange) == null ||
            _.call(y, d));
      },
      Ae = (l) => {
        var d, y;
        ((I.value = !0),
          t("focus", l),
          (y = (d = m.value) == null ? void 0 : d.onFocus) == null ||
            y.call(d, l));
      },
      Te = (l) => {
        var d, y;
        ((I.value = !1),
          ie(x.value, l),
          t("blur", l),
          (y = (d = m.value) == null ? void 0 : d.onBlur) == null ||
            y.call(d, l));
      },
      se = (l) => {
        var d, y, _;
        ...
        if (l.type === "compositionend") {
          ...
          (le(re),
            t("input", re, l),
            (y = (d = m.value) == null ? void 0 : d.onInput) == null ||
              y.call(d, l),
            Z());
        } else
          ((w.value = !0),
            ($.value = x.value + ((_ = l.data) != null ? _ : "")));
      },
      Z = () => {
        (j(),
          ut(() => {
            v.value &&
              x.value !== v.value.value &&
              ((v.value.value = x.value), K());
          }));
      },
      Fe = (l) => {
        var d, y;
      ...
      $e = (l) => {
        ...
        return p(
          "span",
          ee({ class: qe.value, onMousedown: Pe }, l ? void 0 : be.value),
          [
            ...
            D.value &&
              p(
                ge,
                { prefix: s, class: `${s}-clear-btn`, onClick: Ge },
                { default: () => [p(et, null, null)] },
              ),
      ...
      render: () =>
        n.prepend || n.append || e.prepend || e.append
          ? p("span", ee({ class: He.value }, be.value), [
              (n.prepend || e.prepend) &&
                p("span", { class: `${s}-prepend` }, [
                  n.prepend ? n.prepend() : e.prepend,
                ]),
              $e(!0),
              (n.append || e.append) &&
                p("span", { class: `${s}-append` }, [
                  n.append ? n.append() : e.append,
                ]),
            ])
          : $e(),
    };
    ...
    const { size: i } = ne(e),
      ...
      s = () => {
        ...
        return p(me, null, [
          e.loading
            ? p(Le, null, null)
            : p(ge, { onClick: f }, { default: () => [p(we, null, null)] }),
  ...
  It = S({
    ...
    setup(e, { emit: t }) {
      const { visibility: n, defaultVisibility: i } = ne(e),
        ...
        s = (v) => {
          v !== a.value &&
            (t("visibility-change", v), t("update:visibility", v), f(v));
        };
...
function _t(e, t, n, i, r, o) {
  ...
  return (
    ...
    X(
      ...
      ct({ _: 2 }, [
        e.$slots.prepend
          ? { name: "prepend", fn: G(() => [E(e.$slots, "prepend")]), key: "0" }
          : void 0,
        e.$slots.prefix
          ? { name: "prefix", fn: G(() => [E(e.$slots, "prefix")]), key: "1" }
          : void 0,
        e.invisibleButton || e.$slots.suffix
          ...
          : void 0,
        e.$slots.append
          ? { name: "append", fn: G(() => [E(e.$slots, "append")]), key: "3" }
          : void 0,
      ]),
      1032,
      ["type"],
...
function jt(e, t, n, i, r, o) {
  return (
    B(),
    A("div", { class: T(e.prefixCls) }, [E(e.$slots, "default")], 2)
  );
}
        ...
        return p(
          ...
          [
            Array(Nt)
              .fill(1)
              .map((i, r) =>
                p("div", { class: `${t}-item`, key: r, style: n }, null),
              ),
          ],
        );
      };
      ...
      const n = z("spin"),
        ...
        a = () => {
          ...
          return p(me, null, [
            ...
            c &&
              p("div", { class: `${n}-tip` }, [
                (v = (s = t.tip) == null ? void 0 : s.call(t)) != null
                  ? v
                  : e.tip,
              ]),
          ]);
...
function Vt(e, t, n, i, r, o) {
  return (
    ...
    A(
      "div",
      { class: T(e.classNames), style: q(e.styles) },
      [E(e.$slots, "default")],
      6,
    )
  );
...
function Pt(e) {
  if (
    (xe(e) && (["initial", "auto", "none"].includes(e) || /^\d+$/.test(e))) ||
    R(e)
  )
    return e;
...
function Tt(e, t, n, i, r, o) {
  return e.visible
    ? (B(),
      A(
        "div",
        { key: 0, class: T(e.classNames), style: q(e.styles) },
        [E(e.$slots, "default")],
        6,
      ))
    : Ee("v-if", !0);
