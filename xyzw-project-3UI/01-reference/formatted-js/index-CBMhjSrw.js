        ...
        (o =
          (n = i == null ? void 0 : i.prefixCls) != null
            ...
            : (t =
                  r == null
                    ? void 0
                    : r.appContext.config.globalProperties[Te]) == null
              ? void 0
              : t.classPrefix) != null
          ? o
          : un;
      ...
      de(i) || fe(i) || (t && Fn(i, i.children))
        ...
        : We(i, i.children)
          ...
          : Ct(i, i.children)
            ? r.push(
                ...we(
                  (o = (n = i.children).default) == null ? void 0 : o.call(n),
                  t,
                ),
              )
            : se(i) && r.push(...we(i, t));
...
const _t = Object.assign($e, {
  ...
  Xn = w({
    ...
    components: {
      IconLoading: _t,
      IconCheckCircleFill: xn,
      IconExclamationCircleFill: Wn,
      IconCloseCircleFill: Gn,
    },
...
const io = w({
  ...
  setup(e) {
    const { type: t, size: n, status: o, disabled: r, shape: i } = ue(e),
      l = S("btn-group");
    return (
      ct($t, Pe({ type: t, size: n, shape: i, status: o, disabled: r })),
      { prefixCls: l }
    );
  },
});
function lo(e, t, n, o, r, i) {
  return (
    g(),
    C("div", { class: E(e.prefixCls) }, [j(e.$slots, "default")], 2)
  );
}
var Oe = $(io, [["render", lo]]);
...
const so = () => {
  ...
  co = (
    e,
    t,
    { containerRect: n, triggerRect: o, popupRect: r, offset: i, translate: l },
  ) => {
    const s = ao(e),
      a = so(),
      d = {
    ...
    if (s === "top" && d.top < 0)
      if (o.top > r.height) t.top = -n.top;
        ...
        a.height - (n.top + v.top + r.height) > 0 &&
          ((f = re(e, "bottom")), (t.top = v.top));
      }
    if (s === "bottom" && d.bottom < 0)
      if (a.height - o.bottom > r.height)
        t.top = -n.top + (a.height - r.height);
      else {
    ...
    if (s === "left" && d.left < 0)
      if (o.left > r.width) t.left = -n.left;
        ...
        a.width - (n.left + v.left + r.width) > 0 &&
          ((f = re(e, "right")), (t.left = v.left));
      }
    ...
    return (
      (s === "top" || s === "bottom") &&
        (d.left < 0
          ? (t.left = -n.left)
          : d.right < 0 && (t.left = -n.left + (a.width - r.width))),
      (s === "left" || s === "right") &&
        (d.top < 0
          ? (t.top = -n.top)
          : d.bottom < 0 && (t.top = -n.top + (a.height - r.height))),
  ...
  fo = (e) => {
    ...
    return (
      ["left", "right"].includes(e)
        ? (n = "50%")
        : ["top", "tl", "tr", "lb", "rb"].includes(e) && (n = "100%"),
      `${t} ${n}`
    );
  },
  ho = (
    ...
    return {
      style: { left: `${d.left}px`, top: `${d.top}px`, ...l },
      position: a,
    };
  },
  vo = (e, t, n, { customStyle: o = {} }) => {
    if (["top", "tl", "tr", "bottom", "bl", "br"].includes(e)) {
      ...
      return (
        i > n.width - 8 &&
          (t.width > n.width ? (i = n.width / 2) : (i = n.width - 8)),
  ...
  setup(e, { emit: t, slots: n }) {
    ...
    return (
      ...
      () => {
        var a;
        return (
          (o.value = (a = n.default) == null ? void 0 : a.call(n)),
          o.value
        );
      }
    );
...
var Ae = w({
  ...
  setup(e, { emit: t, slots: n, attrs: o }) {
    ...
    const m = h(() => {
      ...
      { teleportContainer: zt, containerRef: he } = Bo({
        popupContainer: r,
        visible: m,
        documentContainer: !0,
      }),
    ...
    const Mt = () => {
      ...
      z = () => {
        ...
        (e.autoFitTransformOrigin && (q.value = { transformOrigin: fo(x) }),
          e.autoFitPopupMinWidth
            ? (A.minWidth = `${c.width}px`)
            : e.autoFitPopupWidth && (A.width = `${c.width}px`),
          D.value !== x && (D.value = x),
          (H.value = A),
          e.showArrow &&
            et(() => {
      ...
      k = (u, c) => {
        ...
        (u || ((R = null), (ee = null)),
          c ? (Mt(), u !== m.value && (Y = window.setTimeout(y, c))) : y());
      },
      Tt = (u) => {
        var c;
        ((c = o.onClick) == null || c.call(o, u),
          !(e.disabled || (m.value && !e.clickToClose)) &&
            (a.value.includes("click")
              ? (me(u), k(!m.value))
              : a.value.includes("contextMenu") && m.value && k(!1)));
      },
      qe = (u) => {
        var c;
        ((c = o.onMouseenter) == null || c.call(o, u),
          !(e.disabled || !a.value.includes("hover")) &&
            (me(u), k(!0, e.mouseEnterDelay)));
      },
      Ge = (u) => {
      ...
      Lt = (u) => {
        var c;
        ((c = o.onFocusin) == null || c.call(o, u),
          !(e.disabled || !a.value.includes("focus")) && k(!0, e.focusDelay));
      },
      Pt = (u) => {
        var c;
        ((c = o.onFocusout) == null || c.call(o, u),
          !(e.disabled || !a.value.includes("focus")) &&
            e.blurToClose &&
            k(!1));
      },
      xt = (u) => {
        ...
        ((c = o.onContextmenu) == null || c.call(o, u),
          !(
            e.disabled ||
            !a.value.includes("contextMenu") ||
            (m.value && !e.clickToClose)
    ...
    const pe = () => {
      ...
      ge = (u) => {
        ...
        if (
          !(
            ((c = L.value) != null && c.contains(u.target)) ||
            ((y = b.value) != null && y.contains(u.target))
          )
        ) {
          for (const A of d)
            if ((P = A.value) != null && P.contains(u.target)) return;
          (pe(), k(!1));
        }
      },
      Xe = (u, c) => {
        ...
        return (
          Math.abs(A - y) >= e.scrollToCloseDistance ||
          Math.abs(x - P) >= e.scrollToCloseDistance
        );
      },
      te = ot((u) => {
        if (m.value)
      ...
      if (
        (e.clickOutsideToClose &&
          (!u && O
            ...
            : u &&
              !O &&
              (ke(document.documentElement, "mousedown", ge), (O = !0))),
        (e.scrollToClose || (s != null && s.scrollToClose)) &&
          (ke(window, "scroll", Ue), (ve = !0)),
    ...
    const { createResizeObserver: Vt, destroyResizeObserver: Ht } = wo({
      elementRef: he,
      onResize: be,
    });
    (U(() => {
      ...
      je(() => {
        if (
          (f == null || f.removeChildRef(b), Ht(), O && pe(), ve && Je(), B)
        ) {
    ...
    return () => {
      ...
      return (
        (v.value =
          (c = (u = n.default) == null ? void 0 : u.call(n)) != null ? c : []),
        Et(v.value, {
          class: Wt.value,
          onClick: Tt,
          onMouseenter: qe,
        ...
        F(tn, null, [
          e.autoFixPosition
            ? F(st, { onResize: It }, { default: () => [v.value] })
            : v.value,
          F(ko, null, {
            default: () => [
              F(
                              ...
                              Ut(
                                {
                                  ...
                                  style: {
                                    ...H.value,
                                    zIndex: At.value,
                                    pointerEvents: ne.value ? "none" : "auto",
                                  },
