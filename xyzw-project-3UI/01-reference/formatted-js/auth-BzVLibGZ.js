import { aF as h, r as c, p as u } from "./index-BUwMeHKm.js";
import { u as k } from "./localTokenManager-DrgF481l.js";
const p = h("auth", () => {
  const s = c(null),
    ...
    g = async (e) => {
      try {
        ...
        return (
          console.error("登录错误:", r),
          { success: !1, message: "本地认证失败" }
        );
      } finally {
        o.value = !1;
      }
    ...
    f = async (e) => {
      try {
        ...
        if (r.some((v) => v.username === e.username))
          return { success: !1, message: "用户名已存在" };
        const S = {
          ...e,
          id: "user_" + Date.now(),
          createdAt: new Date().toISOString(),
        ...
        return (
          console.error("注册错误:", r),
          { success: !1, message: "本地注册失败" }
        );
      } finally {
        o.value = !1;
      }
