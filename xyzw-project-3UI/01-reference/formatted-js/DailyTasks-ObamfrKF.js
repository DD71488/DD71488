...
import { S as Y } from "./Settings-k37EgbhI.js";
import { T as fe } from "./Time-DjWqRaft.js";
import { u as pe } from "./gameRoles-BeNVqtZt.js";
import { u as ke } from "./localTokenManager-DrgF481l.js";
import { u as _e } from "./auth-BzVLibGZ.js";
import { R as he } from "./Refresh-Cb4iOY7D.js";
import { C as we } from "./ChevronDown-C2mH2M4K.js";
import { S as ye } from "./Search-Bova80rr.js";
import { C as xe } from "./Cube-vacFy8Vs.js";
const be = {
  ...
  st = {
    ...
    setup(i, { emit: z }) {
      ...
      const d = i,
        ...
        h = $({
          autoExecute:
            ((B = d.task.settings) == null ? void 0 : B.autoExecute) || !1,
          delay: ((M = d.task.settings) == null ? void 0 : M.delay) || 0,
          notification:
            ((I = d.task.settings) == null ? void 0 : I.notification) || !0,
        }),
        U = () =>
          S.value ? "执行中..." : d.task.canExecute ? "立即执行" : "不可执行",
        N = () => {
          ...
          if (!(S.value || !d.task.canExecute))
            try {
              ((S.value = !0),
                ...
                h.value.notification &&
                  y.success(`任务 "${d.task.title}" 执行成功`));
            } catch (k) {
        ...
        T = (k, a) => {
          ((h.value[k] = a),
            O("update:task", { ...d.task, settings: { ...h.value } }));
        },
        A = (k) =>
          new Date(k).toLocaleString("zh-CN", {
            month: "2-digit",
            day: "2-digit",
            hour: "2-digit",
            minute: "2-digit",
        ...
        c = (k) =>
          new Date(k).toLocaleTimeString("zh-CN", {
            hour: "2-digit",
            minute: "2-digit",
            second: "2-digit",
          });
                      ...
                      s("div", Ie, [
                        s("div", Ne, [
                          ...
                          s(
                            "span",
                            We,
                            p(i.task.progress.current) +
                              "/" +
                              p(i.task.progress.total),
                            1,
                          ),
                        ]),
                        i.task.reward
  ...
  Dt = {
    ...
    setup(i) {
      const z = ge(),
        ...
        W = async (t, e = 3, o = 2e3) => {
          for (let u = 1; u <= e; u++)
            try {
              ...
              const L = await y.sendMessageWithPromise(
                t,
                "presetteam_getinfo",
                {},
                8e3,
              ...
              if ((console.error(`第${u}次尝试失败:`, D), u < e))
        ...
        V = (t) => {
          ((v.value = t),
            f.selectRole(f.gameRoles.find((e) => e.id === t)),
            t && C());
        },
        j = (t) => {
          T.value = t;
        ...
        X = async (t) => {
          ...
          try {
            if (S.getWebSocketStatus(v.value) !== "connected") {
              ...
              if (u)
                (S.createWebSocketConnection(v.value, u.token, u.wsUrl),
        ...
        se = (t) => {
          ...
          e !== -1 &&
            ((c.value[e].completed = !c.value[e].completed),
            d.info("任务状态已更新"));
        },
        ae = (t) => {
      ...
      return (
        ve(async () => {
          ...
          if (
            ...
            f.gameRoles.length > 0 &&
              ((v.value = f.gameRoles[0].id), V(v.value));
        }),
        ee(
          () => f.selectedRole,
          (t) => {
