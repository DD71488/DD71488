  ...
  <div class="game-roles-page">
    <div class="container">
      ...
      <div v-if="gameRolesStore.gameRoles.length" class="roles-grid">
        ...
        >
          ...
          <div class="card-body">
            ...
            <div class="role-tags">
              <a-tag size="small" :type="role.isActive ? 'success' : 'default'">
                {{ role.isActive ? "活跃" : "离线" }}
              </a-tag>
              <a-tag v-if="role.vip" size="small"> VIP </a-tag>
            </div>
          </div>
      ...
      <div v-else class="empty-state">
        <a-empty description="暂无游戏角色" size="large">
          <template #icon>
            <IconUser />
          </template>
          <template #extra>
      ...
      >
        <a-form
          ...
          label-width="80px"
        >
          <a-form-item label="角色名称" path="name">
            <a-input
          ...
          <a-form-item label="服务器" path="server">
            <a-select
              v-model="roleForm.server"
              :options="serverOptions"
              placeholder="请选择服务器"
            />
          </a-form-item>

          <a-form-item label="职业" path="profession">
            <a-select
              v-model="roleForm.profession"
              :options="professionOptions"
              placeholder="请选择职业"
            />
          </a-form-item>

          <a-form-item label="等级" path="level">
            <a-input-number
...
import { IconUser, IconPlus, IconMore } from '@arco-design/web-vue/es/icon';
