      ...
      <div class="container">
        ...
        >
          ...
          <n-tabs
            ...
            size="small"
          >
            <n-tab-pane key="daily" title="日常" />
            <n-tab-pane key="club" title="俱乐部" />
            <n-tab-pane key="activity" title="活动" />
            <n-tab-pane v-if="showToolsTab" key="tools" title="工具" />
            <n-tab-pane key="saltFieldGroup" title="盐场" />
            <n-tab-pane key="peachGroup" title="蟠桃园" />
            <n-tab-pane key="rankGroup" title="排行榜" />
            <n-tab-pane key="fightPvp" title="切磋" />
          </n-tabs>
          ...
          <ClubCarKing v-if="activeSection === 'tools'" />
          <CarScoreInfo v-if="activeSection === 'tools'" :inline="true" />
          <ClubWeirdTowerInfo v-if="activeSection === 'tools'" :inline="true" />
          ...
          <div class="salt-field-group" v-if="activeSection === 'saltFieldGroup'">
            <div class="sub-nav">
              <n-tabs
                v-model="saltFieldTab"
                type="card"
                animated
                size="small"
              >
                <n-tab-pane key="warrank" title="盐场" />
                <n-tab-pane key="weekBattle" title="本周盐场战绩" />
                <n-tab-pane key="monthBattle" title="本月盐场战绩" />
                <n-tab-pane key="legionWarMap" title="盐场地图" />
                <n-tab-pane key="legionWarStatistics" title="盐场战况" />
              </n-tabs>
            </div>
          ...
          <div class="peach-group" v-if="activeSection === 'peachGroup'">
            <div class="sub-nav">
              <n-tabs
                ...
                size="small"
              >
                <n-tab-pane key="peach" title="蟠桃园信息" />
                <n-tab-pane key="peachBattle" title="蟠桃园战绩" />
              </n-tabs>
            </div>
          ...
          <div class="rank-group" v-if="activeSection === 'rankGroup'">
            <div class="sub-nav">
              <n-tabs
                ...
                size="small"
              >
                <n-tab-pane key="serverrank" title="区服榜" />
                <n-tab-pane key="toprank" title="巅峰榜" />
                <n-tab-pane key="topclubrank" title="俱乐部榜" />
                <n-tab-pane key="goldclubrank" title="黄金积分榜" />
                <n-tab-pane key="greatRouteRank" title="伟大航路积分榜" />
              </n-tabs>
            </div>
...
import CarScoreInfo from "@/components/Club/CarScoreInfo.vue";
import ClubWeirdTowerInfo from "@/components/Club/ClubWeirdTowerInfo.vue";
...
import SignInCard from "@/components/Club/Signin.vue";
