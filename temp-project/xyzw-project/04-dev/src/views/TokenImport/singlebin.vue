<template>
  ...
  <a-form :model="importForm" :label-placement="'top'" :size="'large'" :show-label="true">
    <a-form-item :label="'游戏角色名称'" :show-label="true">
      <a-input v-model="importForm.name" placeholder="例如：主号战士" clearable />
    </a-form-item>
      ...
      <a-collapse-item title="角色详情 (可选)" name="optional">
        <div class="optional-fields">
          <a-form-item label="服务器">
            <a-input v-model="importForm.server" placeholder="服务器名称" />
          </a-form-item>

          <a-form-item label="自定义连接地址">
            <a-input v-model="importForm.wsUrl" placeholder="留空使用默认连接" />
          </a-form-item>
        </div>
      </a-collapse-item>
    </a-collapse>
