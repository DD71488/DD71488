<template>
  ...
  >
    ...
    >
      ...
      <a-tab-pane v-if="ENABLE_TOOLS_TAB" key="tools" title="工具" />
    ...
    <div class="salt-field-group" v-if="activeSection === 'saltFieldGroup'">
      ...
      >
        <a-tabs
          type="card"
          animated
          v-model:active-key="saltFieldSubTab"
          size="small"
        >
    ...
    <div class="peach-group" v-if="activeSection === 'peachGroup'">
      ...
      >
        <a-tabs
          type="card"
          animated
          v-model:active-key="peachSubTab"
          size="small"
        >
    ...
    <div class="rank-group" v-if="activeSection === 'rankGroup'">
      <div
        ...
        "
      >
        <a-tabs type="card" animated v-model:active-key="rankSubTab" size="small">
...
.section-tabs :deep(.arco-tabs-content) {
  display: none;
}
