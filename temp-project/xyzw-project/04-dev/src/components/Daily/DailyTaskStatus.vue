      ...
      <div class="settings-content">
        <div class="settings-grid">
          ...
          <div class="setting-item">
            ...
            <a-select
              v-model="settings.arenaFormation"
          ...
          <div class="setting-item">
            ...
            <a-select
              v-model="settings.bossFormation"
              :options="formationOptions"
              size="small"
            />
          </div>
          ...
          <div class="setting-switches">
            <div class="switch-row">
              ...
              <a-switch v-model="settings.claimBottle" />
            </div>

            <div class="switch-row">
              <span class="switch-label">领挂机</span>
              <a-switch v-model="settings.claimHangUp" />
            </div>

            <div class="switch-row">
              <span class="switch-label">竞技场</span>
              <a-switch v-model="settings.arenaEnable" />
            </div>

            <div class="switch-row">
              <span class="switch-label">开宝箱</span>
              <a-switch v-model="settings.openBox" />
            </div>

            <div class="switch-row">
              <span class="switch-label">领取邮件奖励</span>
              <a-switch v-model="settings.claimEmail" />
            </div>
            <div class="switch-row">
              <span class="switch-label">黑市购买物品</span>
              <a-switch v-model="settings.blackMarketPurchase" />
            </div>

            <div class="switch-row">
              <span class="switch-label">付费招募</span>
              <a-switch v-model="settings.payRecruit" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="task-list">
        <div v-for="task in tasks" :key="task.id" class="task-item">
          <div class="task-item-left">
            <CheckmarkCircle class="task-status-icon"heckmarkCircle v-if="task.completed" />
              <EllipseOutline v-else />
            <span class="task-name">{{ task.name }}</span>
          </div>
          <a-tag :type="task.completed ? 'success' : 'default'" size="small">
...
import { IconSettings, IconCalendar, IconCheckCircle, IconFile, IconRefresh } from '@arco-design/web-vue/es/icon';
