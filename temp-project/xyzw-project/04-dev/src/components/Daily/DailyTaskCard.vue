  ...
  <div class="daily-task-card" :class="{ completed: task.completed }">
    ...
    <div class="card-header">
      ...
      <div class="header-right">
        ...
        <a-button type="text" class="settings-button" @click="showSettings = true">
          <template #icon>
            <IconSettings class="settings-icon"conSettings />
          </template>
        </a-button>
      </div>
    </div>
    ...
    >
      <template #header>
        <div class="modal-header">
          <IconSettings class="modal-icon"conSettings />
      ...
      <div class="settings-content">
        <div class="settings-grid">
          <div class="setting-item">
            <a-checkbox
              v-model="taskSettings.autoExecute"
          ...
          <div class="setting-item">
            <a-checkbox
              v-model="taskSettings.notification"
          ...
          <div class="task-list">
            ...
            >
              <div class="task-item-left">
                <CheckCircle class="task-status-icon"heckCircle v-if="detail.completed" />
                  <Clock v-else />
...
import { IconSettings, IconCheck as CheckCircle, IconClockCircle as Clock } from '@arco-design/web-vue/es/icon';
