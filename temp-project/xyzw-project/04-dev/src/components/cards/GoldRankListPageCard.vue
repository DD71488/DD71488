      ...
      <div class="header-section">
        ...
        >
          <div class="stat-item">
            ...
            <a-tag type="info">{{ formatTimestamp1(inputDate1) }}</a-tag>
          </div>
        </div>
      </div>
      ...
      <div class="function-section">
        <div class="function-left">
          <div class="export-options">
            <a-checkbox-group
              ...
              size="small"
            >
              <a-checkbox value="1">表格导出</a-checkbox>
              <a-checkbox value="2" :disabled="loading1 || !battleRecords1"
                >图片导出</a-checkbox
              >
            </a-checkbox-group>
            <div
        ...
        <div class="function-right">
          <a-radio-group
            ...
            class="radio-group"
          >
            <a-radio value="gold1">1-100</a-radio>
            <a-radio value="gold2">101-200</a-radio>
            <a-radio value="gold3">201-300</a-radio>
            <a-radio value="gold4">301-400</a-radio>
            <a-radio value="gold5">401-500</a-radio>
          </a-radio-group>
          <a-button
            size="small"
            :disabled="loading1"
...
<IconCopy />
      ...
      <div ref="exportDom" class="table-content">
        ...
        <div v-else-if="!loading1" class="empty-state">
          <a-empty description="暂无俱乐部数据" size="large">
            <template #icon>
      ...
      <div v-if="playerInfo" class="player-info-content">
        ...
        <div v-if="fightResult.visible" class="fight-result">
          ...
          <div class="result-actions">
            <a-button type="primary" @click="resetFightResult"
              >重新切磋</a-button
            >
...
import { CheckboxGroup } from '@arco-design/web-vue'
...
import { IconTrophy, IconRefresh, IconCopy, IconDown, IconUp, IconFile } from '@arco-design/web-vue/es/icon';
import {
  getLastSaturday,
  formatTimestamp,
  formatTimestamp1,
