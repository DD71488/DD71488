...
import { C as V } from "./Cube-vacFy8Vs.js";
import { A as q } from "./Add-DAhPk3tV.js";
import { C as F } from "./CheckmarkCircle-CZVk2KyH.js";
const L = {
      ...
      const t = S(),
        ...
        l = () => {
          try {
            ...
            (console.error("❌ 导航失败:", a),
              d.error("导航到Token管理页面失败"));
          }
        },
        w = (a) => {
          switch (a.action) {
                      ...
                      e("div", K, [
                        p(
                          u,
                          {
                            ...
                            onClick:
                              s[0] ||
                              (s[0] = (o) => k(t).push("/admin/game-features")),
                          },
                          {
                            default: _(() => [
                              ...(s[1] || (s[1] = [h(" 进入游戏功能 ", -1)])),
                          ...
                          (o) => (
                            ...
                            i(
                              ...
                              [
                                ...
                                e("div", Y, [
                                  e("h3", null, c(o.title), 1),
                                  e("p", null, c(o.description), 1),
                                ]),
                              ],
                              8,
                              U,
