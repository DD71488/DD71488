import { T as wt, H as Pe } from "./ThemeToggle-i1AMbdGp.js";
import {
  k as ue,
  c as E,
  h as g,
...
import zt from "./manual-D5fO84-H.js";
import Bt from "./url-CDPFGLtc.js";
import Et from "./bin-CC8h7f6I.js";
import It from "./singlebin-g6-JdQQP.js";
import Pt from "./wxqrcode-C3dNzXLv.js";
import { _ as Lt } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { M as Ot, C as Nt } from "./index-Eg6ki802.js";
import { E as Wt, T as jt } from "./index-Dne5XMpP.js";
import { A as We } from "./Add-DAhPk3tV.js";
import { M as Ft } from "./Menu-y2o6ukBF.js";
import { C as me, a as Vt, S as Qt, T as Kt } from "./index-Dp53-x2x.js";
import {
  g as Qe,
  s as Ke,
  a as Ge,
...
import { R as pe } from "./Refresh-Cb4iOY7D.js";
import { E as Fe } from "./EllipsisHorizontal-eOImISpV.js";
import "./CloudUpload-CqW5D9SP.js";
import "./AlertCircleOutline-DSz5dGmY.js";
import "./ServerRoleList-K5eSJYby.js";
import "./legionWar-5YonzZw2.js";
import "./Search-Bova80rr.js";
import "./index-CwMhWr3d.js";
  ...
  setup(m, { slots: k }) {
    const {
      ...
      H = oe(() => {
        ...
        const Q =
          !(I != null && I.value) || sn.includes(I == null ? void 0 : I.value)
            ? {}
            : { backgroundColor: I.value };
        return {
          mergedStyle: { ...Q, ...$ },
          computedDotStyle: $,
          computedColorStyle: Q,
        };
      }),
      J = () => {
...
const an = (m, k, b) =>
    oe(() => [m, { [`${m}-status`]: k, [`${m}-no-children`]: !b }]),
  rn = Object.assign(fe, {
    install: (m, k) => {
      Ke(m, k);
      const b = Ge(k);
...
var ve = ue({
  ...
  setup(m, { slots: k }) {
    ...
    return () => {
      var y;
      const a = Gt((y = k.default) == null ? void 0 : y.call(k), !0).filter(
        (f) => f.type !== _t,
      );
      return s("div", { class: T.value }, [
        a.map((f, _) => {
          ...
          return s(ge, { key: (O = f.key) != null ? O : `item-${_}` }, [
            J &&
              s("div", { class: `${b}-item-split`, style: l(!1) }, [
                (H = k.split) == null ? void 0 : H.call(k),
              ]),
  ...
  Nn = {
    ...
    setup(m) {
      ...
      const Y = localStorage.getItem("tokenSortConfig"),
          ...
          S.value.field === "manual"
            ...
            : [...a.gameTokens].sort((t, e) => {
                ...
                switch (S.value.field) {
                  case "name":
                    ((r =
                      ((w = t.name) == null ? void 0 : w.toLowerCase()) || ""),
                      (i =
                        ((h = e.name) == null ? void 0 : h.toLowerCase()) ||
                        ""));
                    break;
                  case "server":
                    ((r =
                      ((M = t.server) == null ? void 0 : M.toLowerCase()) ||
                      ""),
                      (i =
                        ((v = e.server) == null ? void 0 : v.toLowerCase()) ||
                        ""));
                    break;
                  case "createdAt":
                    ((r = new Date(t.createdAt || 0).getTime()),
                      (i = new Date(e.createdAt || 0).getTime()));
                    break;
                  case "lastUsed":
                    ((r = new Date(t.lastUsed || 0).getTime()),
                      (i = new Date(e.lastUsed || 0).getTime()));
                    break;
                  default:
                    ((r =
                      ((j = t.name) == null ? void 0 : j.toLowerCase()) || ""),
                      (i =
                        ((G = e.name) == null ? void 0 : G.toLowerCase()) ||
                        ""));
                }
                return r < i
        ...
        re = (t) =>
          S.value.field !== t ? null : S.value.direction === "asc" ? "↑" : "↓",
        ke = (t, e) => {
            ...
            if (t.importMethod === "url") {
              ...
              if (
                ...
                try {
                  ...
                  throw new Error(
                    `跨域请求被阻止。请确保目标服务器支持CORS。错误详情: ${h.message}`,
                  );
                }
              if (!e.ok)
                throw new Error(`请求失败: ${e.status} ${e.statusText}`);
              const i = await e.json();
              if (!i.token) throw new Error("返回数据中未找到token字段");
              (a.updateToken(t.id, {
                token: i.token,
                server: i.server || t.server,
              ...
              w &&
                (a.getWebSocketStatus(t.id) === "connected" &&
              ...
              if ((e || ((e = await k(t.name)), (r = !0)), !e))
                throw new Error(
                  `无法在本地存储中找到Token "${t.name}" 的原始数据，请重新导入Token`,
                );
              const i = await Rt(e);
              (a.updateToken(t.id, { token: i, lastRefreshed: Date.now() }),
                r &&
                  (await b(t.id, e),
                  await I(t.name),
                  console.log("已迁移IndexedDB数据:", t.name, "->", t.id)),
                (a.tokenAutoRefreshStatus[t.id] = {
                  lastRefresh: Date.now(),
                  status: "success",
                }),
...
2. 尝试重新连接现有Token`,
                  ...
                  onNegativeClick: () => {
                    (a.getWebSocketStatus(t.id) === "connected" &&
                      a.closeWebSocketConnection(t.id),
                      setTimeout(() => {
                        (a.createWebSocketConnection(t.id, t.token, t.wsUrl),
                          l.info("正在尝试重新连接..."));
                      }, 500));
                  },
                }));
          ...
          const e = [
            {
              label: "编辑",
              key: "edit",
              icon: () => V(x, null, { default: () => V(me) }),
            },
            {
              label: "复制Token",
              key: "copy",
              icon: () => V(x, null, { default: () => V(Nt) }),
            },
          ];
          return (
            t.importMethod === "url" && t.sourceUrl
              ? e.push({
                  label: "从URL刷新",
                  key: "refresh-url",
                  icon: () => V(x, null, { default: () => V(Qt) }),
                })
              : e.push({
                  label: "重新获取",
                  key: "refresh",
                  icon: () => V(x, null, { default: () => V(pe) }),
                }),
            e.push(
              { type: "divider" },
              {
            ...
            onPositiveClick: async () => {
              try {
                let r = 0,
                  i = 0;
                const w = [],
                  h = l.loading(`正在批量刷新Token (0/${t.length})`, {
                    duration: 0,
                  });
                for (let v = 0; v < t.length; v++) {
                  const j = t[v];
                  try {
                    ((h.content = `正在刷新Token (${v + 1}/${t.length}): ${j.name}`),
                      await Z(j),
                      r++);
                  } catch (q) {
                  ...
                  v < t.length - 1 &&
                    (await new Promise((q) => setTimeout(q, G)));
                }
                h.destroy();
                let M = "";
                (i > 0 &&
...
预计耗时：约3-5秒/个Token`,
              ...
              try {
                ...
                for (let w = 0; w < a.gameTokens.length; w++) {
                  ...
                  try {
                    ...
                    (console.error(`更新Token "${h.name}" 失败:`, M),
                      e++,
                      l.error(`Token "${h.name}" 信息更新失败`));
                  }
                  w < a.gameTokens.length - 1 &&
          ...
          if (T.token || T.api)
            try {
              ...
              if (T.api) {
                ...
                const e = await fetch(T.api, {
                  method: "GET",
                  headers: { Accept: "application/json" },
                  mode: "cors",
                });
                if (!e.ok)
                  throw new Error(`API请求失败: ${e.status} ${e.statusText}`);
                const r = await e.json();
                if (!r.token) throw new Error("API返回数据中未找到token字段");
                t = a.importBase64Token(
                  T.name || r.name || "通过API导入的Token",
                  r.token,
                  {
                ...
                T.token &&
                  (l.info("正在导入token..."),
                  (t = a.importBase64Token(
                    T.name || "通过URL导入的Token",
                    T.token,
                    { server: T.server, wsUrl: T.wsUrl, importMethod: "url" },
                  )));
              if (t && t.success)
                ...
                throw new Error(
                  (t == null ? void 0 : t.message) || "Token导入失败",
                );
            } catch (t) {
              (console.error("URL参数处理失败:", t),
                l.error(`导入失败: ${t.message}`),
                L.replace("/tokens"));
            } finally {
              _.value = !1;
            }
      ...
      return (
        ...
        Ut(async () => {
          (a.initTokenStore(),
            await ze(),
            !a.hasTokens && !T.token && !T.api && (f.value = !0));
        }),
        (t, e) => {
          const r = wt,
            i = B("n-radio-button"),
                  ...
                  u("div", mn, [
                    u("div", pn, [
                      e[32] ||
                        (e[32] = u(
                          "img",
                          { src: Dt, alt: "XYZW", class: "brand-logo" },
                          null,
                          -1,
                        )),
                      s(r),
                                          ...
                                          ? (g(),
                                            E(
                                              "div",
                                              {
                                                key: 0,
                                                class:
                                                  "token-remark token-remark-edit",
                                                onClick:
                                                  e[19] ||
                                                  (e[19] = F(() => {}, [
                                                    "stop",
                    ...
                    z(
                      ...
                      { key: 1 },
                      {
                        image: o(() => [
                          ...(e[58] ||
                            (e[58] = [
                              u("i", { class: "mdi:bed-empty" }, null, -1),
                            ])),
                        ]),
                        default: o(() => [
