...
import { g as ge, X as _e } from "./DateTimeUtils-DvYIltNF.js";
import {
  x as Me,
  s as Pe,
  r as W,
...
const Ee = { class: "legion-war-container" },
  ...
  Ke = {
    ...
    setup(Je) {
      ...
      U(() =>
        (w == null ? void 0 : w.status) === "connected" ? "已连接" : "未连接",
      );
      const V = U(() =>
          ...
          for (let s = 0; s < n.length; s++) {
            ...
            try {
              ...
              c.message.includes("频繁") &&
                (await new Promise((u) => setTimeout(u, l * 2)),
                await b.sendMessageToLegion(t, n[s]));
            }
          }
        },
      ...
      const le = W(null),
        ...
        se = (e = 0, n = 0, t = "") => {
          ...
          (l.getAllNodes().forEach((o) => {
            ...
            (H.value &&
              o.type != 4 &&
              ((o.belongsLegionId = -1), (o.colorBg = Be(9))),
              parseInt(r) >= 0 &&
              parseInt(r) < 41 &&
              parseInt(d) >= 0 &&
              parseInt(d) < 32
            ...
            for (let r = 0; r <= 40; r++)
              if (o > 2 && a[o][r] != 0) {
                ...
                if ((ye(d, p, m), a[o][r].type != 9)) {
                  ...
                  (v == "大本营" &&
                    ((i.fillStyle = "#055138"),
                    (v = C.value.legionInfo[a[o][r].belongsLegionId].name)),
          ...
          for (let o = 0; o < u.length; o++)
            ((i.fillStyle = "black"),
              ...
              i.fillText(u[o].name, u[o].x, u[o].y));
          c.type != 9 &&
          ...
          if (e) {
            ...
            if (!X.value)
              ...
              (Object.values(e.memberInfo).forEach((l) => {
                var s, c;
                l.legionId ==
                  ((c = (s = b.gameData) == null ? void 0 : s.roleInfo) == null
                    ? void 0
                    : c.role.legionId) &&
                  t.push([
                    l.name,
        ...
        ke = (e, n) => {
          ...
          for (let x = 0; x < o; x++) {
            ...
            for (let y = 0; y < u; y++) {
              let R = y === 0 ? T + ce : T;
              ((R = y === 1 ? T - de : R),
                (e.fillStyle = ((ue = d[x]) == null ? void 0 : ue[9]) || k));
              const J = M,
                Q = c + (x + 1) * g;
              (e.fillRect(J, Q, R, g),
            ...
            (b.createWebSocketConnection(e, n),
              ...
              setTimeout(async () => {
                if (b.getWebSocketStatus(e) === "connected") {
                  ...
                  const l = await b.sendMessageWithPromise(
                    e,
            ...
            ((N.value = e == null ? void 0 : e.info.battlefieldId),
              ...
              (w.onConnect = async () => {
                try {
                  setTimeout(() => {
                    j.value = !0;
                    const s = w.send("war_enterbattlefield", {
              ...
              w.setMessageListener((s) => {
                ((s == null ? void 0 : s.cmd) || "unknown").includes(
                  "war_getbattlefieldinfo",
                ) &&
                  (console.log(s.rawData),
                  (le.value = s == null ? void 0 : s.rawData),
                  ie(G.value));
              }),
              (w.onDisconnect = (s) => {
            ...
            ze("div", Ee, [
              f("div", Oe, [
                ...
                f("div", Fe, [
                  f(
                    "canvas",
                    { ref_key: "legionWarMapDom", ref: G, class: "mapCanvas" },
                    null,
                    512,
                  ),
                ]),
