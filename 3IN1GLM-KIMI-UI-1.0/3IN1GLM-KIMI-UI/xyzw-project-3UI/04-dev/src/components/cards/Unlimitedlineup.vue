<template>
  <MyCard class="lineup-saver" :statusClass="{ active: state.isRunning }">
    ...
    <template #default>
      ...
      <a-modal
        v-model:visible="savedLineupsModalVisible"
        preset="card"
        title="已保存的阵容"
        ...
        <div v-else class="saved-lineups-modal-content">
          <div class="team-tabs">
            ...
            <div class="team-tabs-right">
              <a-button size="tiny" @click="exportLineups"> 导出 </a-button>
              <a-upload
                :show-file-list="false"
                :custom-request="importLineups"
                accept=".json"
              >
                <a-button size="tiny">导入</a-button>
              </a-upload>
            </div>
          </div>
      ...
      <a-modal
        v-model:visible="refineModalVisible"
        preset="card"
        :title="refineModalTitle"
        style="width: 600px; max-width: 90vw"
      >
        <a-spin :show="refineModalLoading">
            ...
            >
              ...
              <div class="slots-container">
                ...
                >
                  ...
                  <a-tag v-if="slot.isLocked" size="small" type="warning"
                    >锁定</a-tag
                  >
                </div>
              </div>
      ...
      >
        ...
        <template #footer>
          <div style="display: flex; justify-content: flex-end; gap: 8px">
            <a-button @click="exchangeModalVisible = false">取消</a-button>
            <a-button
              type="primary"
