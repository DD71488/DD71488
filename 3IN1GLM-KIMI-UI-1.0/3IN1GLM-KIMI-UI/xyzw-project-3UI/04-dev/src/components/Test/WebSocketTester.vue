<template>
  <div class="websocket-tester">
    <a-card title="WebSocket连接测试" class="mb-4">
      <a-space direction="vertical" size="large">
        <!-- 连接状态 -->
        <a-card title="连接状态" size="small">
          <a-space align="center">
            <a-tag :type="getStatusType(status)" size="large">
        ...
        <!-- 连接详情 -->
        <a-card v-if="connectionDetails" title="连接详情" size="small">
          <a-descriptions :column="2" bordered size="small">
            <a-descriptions-item label="角色ID">
              {{ connectionDetails.roleId }}
            </a-descriptions-item>
            <a-descriptions-item label="状态">
              <a-tag :type="getStatusType(connectionDetails.status)">
        ...
        <!-- 游戏命令测试 -->
        <a-card v-if="status === 'connected'" title="游戏命令测试" size="small">
          <a-space direction="vertical">
            ...
            <a-form-item v-if="selectedCommand" label="命令参数 (JSON)">
              <a-input
          ...
          <div class="message-log">
            ...
            >
              <div class="message-header">
                ...
                <a-typography-text depth="3" style="font-size: 12px">
