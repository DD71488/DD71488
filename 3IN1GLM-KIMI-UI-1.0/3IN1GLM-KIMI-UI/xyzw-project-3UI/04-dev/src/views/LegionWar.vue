  ...
  <div class="legion-war-container">
    <div class="legion-war-map">
      <div class="map-title">
        ...
        <div >
          <span>是否进入战场:</span>
          <a-button type="text" @click="getBattlefieldInfo">
    ...
    <div class="legion-war-operation">
      ...
      <div class="legion-war-operation-container">
        <div class="legion-war-operation-item">
          ...
          <div>
            <a-switch v-model="isOccupyOrDistribution" @update:value="handleChange"/>
          </div>
          <div>
            分布布局
          </div>
        ...
        <div class="legion-war-operation-item">
          ...
          <div>
            <a-switch v-model="isLegionOrIndividual" @update:value="handleChange"/>
          </div>
          <div>
            个人战况
          </div>
        ...
        <div class="legion-war-operation-item">
          <a-button type="primary" @click="getBattlefieldInfo" :disabled="!isEntireBattlefield" style="padding:12px">
            拉取数据(需进入战场后)
          </a-button>
        </div>
        <div class="legion-war-operation-item">
          <a-button type="primary" @click="sendMessageToLegion" style="padding:12px">
            发送各战队免费复活到战队频道
          </a-button>
        </div>
      </div>
