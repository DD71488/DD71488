...
<IconPlus />
        ...
        <div class="card-header">
          ...
          >
            ...
            <a-radio value="url"> URL获取 </a-radio>
            <a-radio value="wxQrcode"> 微信扫码获取 </a-radio>
            <a-radio value="bin"> BIN多角色获取 </a-radio>
            <a-radio value="singlebin"> BIN单角色获取 </a-radio>
          </a-radio-group>
        </div>
        <div class="card-body">
          <manual-token-form
      ...
      <div v-if="tokenStore.hasTokens" class="tokens-section">
        <div class="section-header">
          <a-space align="center">
            ...
            <a-divider vertical style="height: 24px"></a-divider>
          ...
          <div class="header-actions">
            <a-button type="success" @click="goToDashboard">
              <template #icon>
...
<IconPlus />
            ...
            <a-dropdown :options="bulkOptions" @select="handleBulkAction" trigger="click">
              <a-button>
                <template #icon>
...
<IconRefresh />
                ...
                <a-dropdown
                  ...
                  trigger="click"
                >
                  <a-button size="small" circle @click.stop>
                    <template #icon>
...
<IconMore />
    ...
    >
      <a-form
        ...
        label-width="80px"
      >
        <a-form-item label="名称" path="name">
          <a-input v-model="editForm.name" />
        </a-form-item>
        <a-form-item label="Token字符串" path="token">
          <a-input
        ...
        <a-form-item label="服务器">
          <a-input v-model="editForm.server" />
        </a-form-item>
        <a-form-item label="WebSocket地址">
          <a-input v-model="editForm.wsUrl" />
        </a-form-item>
...
import { IconPlus, IconCopy, IconEdit, IconMore, IconApps, IconUnorderedList, IconHome, IconSafe, IconMenu, IconRefresh, IconStar, IconSync, IconDelete } from '@arco-design/web-vue/es/icon';
...
[arco-theme="dark"] .arco-form-item-label,
[arco-theme="dark"] .arco-form-item-label__text {
  color: #ffffff !important;
}

[arco-theme="dark"] .n-input__input,
[arco-theme="dark"] .n-input__textarea {
  color: #ffffff !important;
  background-color: rgba(255, 255, 255, 0.1) !important;
}

[arco-theme="dark"] .n-input__placeholder {
...
[arco-theme="dark"] .import-card {
  background: rgba(45, 55, 72, 0.9) !important;
  color: #ffffff !important;
}

[arco-theme="dark"] .import-card h2 {
  color: #ffffff !important;
}

[arco-theme="dark"] .import-card .subtitle {
  color: rgba(255, 255, 255, 0.7) !important;
}

[arco-theme="dark"] .arco-collapse-item__header {
  color: #ffffff !important;
}

[arco-theme="dark"] .arco-collapse-item__content-wrapper {
  background-color: transparent !important;
}

[arco-theme="dark"] .arco-radio-button {
  color: #ffffff !important;
}

[arco-theme="dark"] .arco-radio-button--checked {
  background-color: rgba(16, 185, 129, 0.8) !important;
  color: #ffffff !important;
}

[arco-theme="dark"] .form-tip {
...
/* 深色主题下的列表区域背景 */
[arco-theme="dark"] .tokens-section {
  background: rgba(45, 55, 72, 0.9);
  color: #ffffff;
}

/* 深色主题下的固定头部 */
[arco-theme="dark"] .section-header {
  background: rgba(45, 55, 72, 0.9);
...
:global([arco-theme="dark"] .token-import-modal .arco-modal) {
