import { aL as u, aM as c, aN as l } from "./index-BUwMeHKm.js";
const g = (o) => {
  if (!o) return "";
  if (o instanceof Uint8Array) return `[BON:${o.length}b]`;
  if (Array.isArray(o)) return `[Array:${o.length}]`;
  if (typeof o == "object") {
    if (Object.keys(o).every((r) => !Number.isNaN(parseInt(r))))
      return `[BON:Object:${Object.keys(o).length}]`;
    try {
...
class f {
    ...
    return (
      this.commands.set(e, (t = 0, s = 0, i = {}) => {
        ...
        return {
          ...
          time: Date.now(),
          body:
            (a = (n = this.encoder) == null ? void 0 : n.bon) != null &&
            a.encode
  ...
  encodePacket(e) {
    var r;
    return (r = this.encoder) != null && r.encode && this.enc
      ? this.encoder.encode(e, this.enc)
      : JSON.stringify(e);
  }
  build(e, r, t, s) {
...
class _ {
  constructor({ url: e, utils: r, hint: t, heartbeatMs: s = 5e3 }) {
    ...
    ((this.url = e),
      (this.utils = r || u),
      (this.enc =
        (i = this.utils) != null && i.getEnc
          ? this.utils.getEnc("auto")
          : void 0),
      (this.socket = null),
      (this.ack = 0),
      (this.seq = 0),
      ...
      (this.socket.onmessage = (e) => {
        ...
        try {
          ...
          if (typeof e.data == "string") t = JSON.parse(e.data);
            ...
            t =
              (r = this.utils) != null && r.parse
                ? this.utils.parse(e.data, "auto", !0)
                : e.data;
            ...
            e.data.arrayBuffer().then((s) => {
              ...
              try {
                if (
                  ((t =
                    (i = this.utils) != null && i.parse
                      ? this.utils.parse(s, "auto", !0)
                      : s),
              ...
              i =
                typeof s.seq == "number"
                  ...
                  : typeof t.seq == "number"
                    ...
                    : void 0;
            if (
              (typeof i == "number" && i >= 0 && (this.ack = i),
              s.body && this.shouldDecodeBody(s.body))
            )
              try {
                if (this.utils && this.utils.bon && this.utils.bon.decode) {
  ...
  convertToUint8Array(e) {
    ...
    if (typeof e == "object" && e.constructor === Object) {
      ...
      if (r.length > 0) {
        ...
        return (
          l.debug("转换对象格式body为Uint8Array:", s.length, "bytes"),
          new Uint8Array(s)
        );
      }
    }
  ...
  decodeBodyForLog(e) {
    ...
    if (!e) return null;
    const r =
      (i = (s = this.utils) == null ? void 0 : s.bon) == null
        ? void 0
        : i.decode;
  ...
  sendWithPromise(e, r = {}, t = 5e3) {
    return new Promise((s, i) => {
      if (!this.connected && !this.socket)
        return i(new Error("WebSocket 连接已关闭"));
      const n = ++this.seq;
  ...
  _setupHeartbeat() {
    (setTimeout(() => {
      var e;
      this.connected &&
        ((e = this.socket) == null ? void 0 : e.readyState) ===
          WebSocket.OPEN &&
              ...
              (this.showMsg || e.cmd === "heart_beat") &&
                ...
                this.showMsg &&
                  ...
                  i instanceof Uint8Array &&
                    i.length > 0 &&
                    c.verbose(
                      `加密验证: 前8字节 [${Array.from(i.slice(0, 8)).join(", ")}]`,
                    ))),
              e.onSent)
            )
              try {
  ...
  _handlePromiseResponse(e) {
    if (e.resp !== void 0 && this.promises[e.resp]) {
      ...
      const a =
        e.rawData !== void 0
          ? e.rawData
          : e.decodedBody !== void 0
            ? e.decodedBody
            : e.body;
      e.code === 0 || e.code === void 0
        ? n.resolve(a || e)
        : n.reject(
            new Error(`服务器错误: ${e.code} - ${e.hint || "未知错误"}`),
          );
      return;
    }
    const r = e.cmd;
  ...
  _clearTimers() {
    (this.heartbeatTimer &&
      ...
      this.sendQueueTimer &&
        (clearInterval(this.sendQueueTimer), (this.sendQueueTimer = null)));
  }
}
function y(o) {
  ((typeof o != "string" || o.trim() === "") && (o = "yyyy-MM-dd HH:mm:ss"),
    (o = o.trim()));
  const r = new Date(),
    t = r.getFullYear(),
