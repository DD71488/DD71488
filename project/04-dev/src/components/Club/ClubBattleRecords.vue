      ...
      <div class="header-section">
        ...
        <div class="stats-section" v-if="battleRecords && battleRecords.roleDetailsList">
          ...
          <div class="stat-item">
            ...
            <a-tag type="success">{{ battleRecords.roleDetailsList.length }}</a-tag>
          </div>
        </div>
      </div>
      ...
      <div class="function-section">
        <div class="function-left">
          <div class="export-options">
            ...
            <a-checkbox-group v-model="exportmethod" name="group-exportmethod" size="small">
...
import { IconRefresh, IconCopy, IconFile } from '@arco-design/web-vue/es/icon'
import {
  getLastSaturday,
