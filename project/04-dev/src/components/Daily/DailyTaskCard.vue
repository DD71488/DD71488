          ...
          <div class="task-list">
            ...
            >
              <div class="task-item-left">
                <IconCheckCircle class="task-status-icon" v-if="detail.completed" />
...
import { IconSettings, IconCheckCircle, IconClockCircle } from '@arco-design/web-vue/es/icon';
