      ...
      <div class="task-list">
        <div v-for="task in tasks" :key="task.id" class="task-item">
          <div class="task-item-left">
            <IconCheckCircle class="task-status-icon" v-if="task.completed" />
              <IconClose v-else />
...
import { IconSettings, IconCalendar, IconCheckCircle, IconFile, IconRefresh, IconClose } from '@arco-design/web-vue/es/icon';
