...
import { S as k } from "./grid-col-CkMxf-H1.js";
const I = {
...
var $ = d({
    ...
    setup(t, { slots: e }) {
      const a = y("card"),
        ...
        { mergedSize: s } = P(l),
        h = w(() =>
          s.value === "small" || s.value === "mini" ? "small" : "medium",
        ),
        v = (r) => {
          const o = V(r);
          return n("div", { class: `${a}-actions` }, [
            n("div", { class: `${a}-actions-right` }, [
              o.map((i, m) =>
                n("span", { key: `action-${m}`, class: `${a}-actions-item` }, [
                  i,
                ]),
              ),
            ]),
        ...
        return n("div", { class: _.value }, [
          (g || M) &&
            n(
              "div",
              {
                class: [`${a}-header`, { [`${a}-header-no-title`]: !g }],
                style: t.headerStyle,
              },
              [
                g &&
                  n("div", { class: `${a}-header-title` }, [
                    (m = (i = e.title) == null ? void 0 : i.call(e)) != null
                      ? m
                      : t.title,
                  ]),
                M &&
                  n("div", { class: `${a}-header-extra` }, [
                    (z = (S = e.extra) == null ? void 0 : S.call(e)) != null
                      ? z
                      : t.extra,
                  ]),
              ],
          ...
          return n("div", { class: a }, [
            (o || i) &&
              n("div", { class: `${a}-content` }, [
                o &&
                  n("div", { class: `${a}-title` }, [
                    (c = (v = e.title) == null ? void 0 : v.call(e)) != null
                      ? c
                      : t.title,
                  ]),
                i &&
                  n("div", { class: `${a}-description` }, [
                    (r = (_ = e.description) == null ? void 0 : _.call(e)) !=
                    null
                      ? r
                      : t.description,
                  ]),
            ...
            (e.avatar || (l == null ? void 0 : l.slots.actions)) &&
              n(
                "div",
                {
                  class: [
                    `${a}-footer `,
                    { [`${a}-footer-only-actions`]: !e.avatar },
                  ],
                },
                [
...
const se = Object.assign($, {
  ...
  install: (t, e) => {
    ...
    const a = H(e);
    (t.component(a + $.name, $),
      t.component(a + p.name, p),
      t.component(a + C.name, C));
  },
});
