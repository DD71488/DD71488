...
import { u as wt } from "./localTokenManager-DrgF481l.js";
import { u as jt } from "./gameRoles-BeNVqtZt.js";
import { _ as it } from "./_plugin-vue_export-helper-DlAUqK2U.js";
import { C as He, a as at, S as _t, T as Ct } from "./index-Dp53-x2x.js";
import { E as Tt } from "./EllipsisHorizontal-eOImISpV.js";
import { R as Be } from "./Refresh-Cb4iOY7D.js";
import { C as St } from "./CloudUpload-CqW5D9SP.js";
import { T as $t } from "./Time-DjWqRaft.js";
import { u as Ot } from "./auth-BzVLibGZ.js";
import {
  _ as me,
  g as ve,
  k as Et,
...
import { T as At } from "./index-C0rjgzG7.js";
import { g as Qe, s as Ze } from "./get-value-by-path-DUUueUA_.js";
import { C as zt, R as Ut, I as qt } from "./grid-col-CkMxf-H1.js";
const Rt = {
  ...
  if (e.clientHeight < e.scrollHeight || e.clientWidth < e.scrollWidth) {
    ...
    return (
      ...
      (function (o) {
        ...
        return (
          !!s &&
          (s.clientHeight < o.scrollHeight || s.clientWidth < o.scrollWidth)
        );
      })(e)
    );
  }
...
var De = function (e, t) {
  ...
  for (
    var x,
      N,
      X = document.scrollingElement || document.documentElement,
      _ = [],
      O = e;
    Xe(O) && j(O);
  ) {
    if (
      (O =
        (N = (x = O).parentElement) == null
          ? x.getRootNode().host || null
          : N) === X
    ) {
      _.push(O);
      break;
  ...
  for (
    ...
    var g = getComputedStyle(r),
      ...
      ze =
        "offsetWidth" in r ? (r.offsetWidth === 0 ? 0 : C / r.offsetWidth) : 0,
      Ue =
        "offsetHeight" in r
          ? r.offsetHeight === 0
            ? 0
    ...
    if (X === r)
      ...
      ((P +=
        Re -
        (R = Math.max(0, Math.min(Re + R / Ue, r.scrollHeight - w / Ue + pe)))),
        (M +=
          qe -
          (oe = Math.max(
            0,
            Math.min(qe + oe / ze, r.scrollWidth - C / ze + de),
          ))));
    }
...
function co(e, t) {
  ...
  e.forEach(function (o) {
    var s = o.el,
      ...
      f = o.left;
    s.scroll && n
      ? s.scroll({ top: a, left: f, behavior: t })
      : ((s.scrollTop = a), (s.scrollLeft = f));
  });
}
function fo(e) {
  return e === !1
...
function po(e, t) {
  ...
  if (ut(t) && typeof t.behavior == "function")
    return t.behavior(n ? De(e, t) : []);
  if (n) {
    var o = fo(t);
    ...
    setup(e, { emit: t }) {
      const n = ve("form"),
        ...
        w = (v, k) => {
          const i = [];
          for (const g of m)
            ((xt(v) && v.includes(g.field)) || v === g.field) &&
              i.push(g.validate());
          ...
          (m.forEach((i) => {
            ...
            Promise.all(k).then((i) => {
              ...
              (i.forEach((L) => {
                ...
                y
                  ? (e.scrollToFirstError && r(Object.keys(g)[0]),
                    t("submitFailed", { values: a.value, errors: g }, v))
    ...
    U(
      "form",
      {
        ...
        onSubmit:
          t[0] ||
          (t[0] = ht(
            (...f) => e.handleSubmit && e.handleSubmit(...f),
            ["prevent"],
          )),
      },
      [ue(e.$slots, "default")],
...
var Pe = function (e, t) {
  ...
  jo = function (e, t) {
    for (var n = t.split("."), o = e, s = 0; s < n.length; s++)
      if (((o = o && o[n[s]]), o === void 0)) return o;
    return o;
  },
  ...
  te = function (t, n) {
    ...
    ((this.getValidateMsg = function (s, a) {
      a === void 0 && (a = {});
      var f = Object.assign(Object.assign({}, a), {
          value: o.obj,
          field: o.field,
          type: o.type,
        }),
...
_e.isRequired.get = function () {
  if (fe(this.obj) || dt(this.obj)) {
    ...
    this.error = {
      ...
      requiredError: !0,
      message:
        this.message || (le(e) ? e : (this._not ? "[NOT MODE]:" : "") + e),
    };
  }
  return this;
};
...
te.prototype.addError = function (t) {
  !this.error &&
    ...
    (this.error = {
      ...
      type: this.type,
      message:
        this.message || (le(t) ? t : (this._not ? "[NOT MODE]:" : "") + t),
    });
};
    ...
    return (
      (t.prototype.maxLength = function (s) {
        return this.obj
          ? this.validate(
              this.obj.length <= s,
              this.getValidateMsg("string.maxLength", { maxLength: s }),
            )
          : this;
      }),
      (t.prototype.minLength = function (s) {
        return this.obj
          ? this.validate(
              this.obj.length >= s,
              this.getValidateMsg("string.minLength", { minLength: s }),
            )
          : this;
      }),
      (t.prototype.length = function (s) {
        return this.obj
          ? this.validate(
              this.obj.length === s,
              this.getValidateMsg("string.length", { length: s }),
            )
          : this;
      }),
    ...
    return (
      (t.prototype.min = function (s) {
        return fe(this.obj)
          ...
          : this.validate(
              this.obj >= s,
              this.getValidateMsg("number.min", { min: s }),
            );
      }),
      (t.prototype.max = function (s) {
        return fe(this.obj)
          ...
          : this.validate(
              this.obj <= s,
              this.getValidateMsg("number.max", { max: s }),
            );
      }),
      (t.prototype.equal = function (s) {
        return fe(this.obj)
          ...
          : this.validate(
              this.obj === s,
              this.getValidateMsg("number.equal", { equal: s }),
            );
      }),
      (t.prototype.range = function (s, a) {
        return fe(this.obj)
          ? this
          : this.validate(
              this.obj >= s && this.obj <= a,
              this.getValidateMsg("number.range", { min: s, max: a }),
            );
      }),
    ...
    return (
      (t.prototype.deepEqual = function (s) {
        return this.obj
          ? this.validate(
              Pe(this.obj, s),
              this.getValidateMsg("object.deepEqual", { deepEqual: s }),
            )
          : this;
      }),
  ...
  Oo = (function (e) {
    function t(o, s) {
      (e.call(
        this,
        o,
        Object.assign(Object.assign({}, s), { type: "boolean" }),
      ),
        this.validate(
          s && s.strict ? ko(this.obj) : !0,
    ...
    return (
      (n.email.get = function () {
        return (
          (this.type = "email"),
          this.validate(
            this.obj === void 0 || Eo.test(this.obj),
      ...
      (n.url.get = function () {
        return (
          (this.type = "url"),
          this.validate(
            this.obj === void 0 || xo.test(this.obj),
      ...
      (n.ip.get = function () {
        return (
          (this.type = "ip"),
          this.validate(
            this.obj === void 0 || Mo.test(this.obj),
        ...
        for (
          var j = function (X) {
              var _ = o.schema[h][X],
                ...
                q = _.message;
              if (!O && !_.validator)
                throw "You must specify a type to field " + h + "!";
              var W = Object.assign(Object.assign({}, o.options), {
                message: q,
                field: h,
              });
              (("ignoreEmptyString" in _) &&
                (W.ignoreEmptyString = _.ignoreEmptyString),
      ...
      const e = ve("form-item-label"),
        ...
        s = () => {
          o.value &&
            ...
            (t == null ||
              t.setLabelWidth(o.value.offsetWidth, n == null ? void 0 : n.uid));
        };
      return (
        Ve(() => {
          o.value &&
        ...
        nt(
          ...
          (f) => (
            ...
            se(
              ...
              {
                default: d(() => [
                  c("div", { role: "alert", class: J([e.prefixCls]) }, I(f), 3),
                ]),
                _: 2,
              },
              1024,
  ...
  setup(e) {
    const t = ve("form-item"),
      ...
      h = V(() => {
        ...
        return (
          e.labelColFlex
            ? (g.flex = e.labelColFlex)
            : o.autoLabelWidth && (g.flex = `${o.maxLabelWidth}px`),
          g
        );
      }),
      j = V(() => {
        var i;
        const g = {
          ...((i = e.wrapperColProps) != null ? i : o.wrapperColProps),
        };
        return (
          n.value && (g.id = ct(o.id, n.value)),
          (e.labelColFlex || o.autoLabelWidth) && (g.flex = "auto"),
          g
        );
      }),
      x = V(() => {
      ...
      z = (i, { status: g, message: y }) => {
        ((_[i] = g),
          (O[i] = y),
          e.noStyle &&
            (B == null || B.updateValidateState(i, { status: g, message: y })));
      },
      ...
      M = () => {
        ...
        const g = H.value;
        if (!n.value || g.length === 0)
          return (q.value && r(), Promise.resolve());
        const y = n.value,
          L = m.value;
        z(y, { status: "", message: "" });
        const D = new Ae(
          {
            [y]: g.map(
              ({ ...Z }) => (!Z.type && !Z.validator && (Z.type = "string"), Z),
            ),
          },
          {
            ignoreEmptyString: !0,
            validateMessages:
              (i = f.value.form) == null ? void 0 : i.validateMessages,
          },
        );
        return new Promise((Z) => {
          D.validate({ [y]: L }, (R) => {
            ...
            z(y, {
              status: de ? "error" : "",
              message:
                (oe = R == null ? void 0 : R[y].message) != null ? oe : "",
            });
            const pe = de
              ? {
                  label: e.label,
        ...
        setField: (i) => {
          ...
          n.value &&
            ...
            "value" in i &&
              ...
              o.model &&
              n.value &&
              Ze(o.model, n.value, i.value),
            (i.status || i.message) &&
              z(n.value, {
                status: (g = i.status) != null ? g : "",
                message: (y = i.message) != null ? y : "",
              }),
            Ce(() => {
              F.value = !1;
            }));
        ...
        ye(
          {
            ...
            class: [
              e.cls,
              {
                [`${e.prefixCls}-has-help`]: !!((f = e.$slots.help) != null
                  ? f
                  : e.help),
              },
            ],
            ...
            e.hideLabel
              ...
              : (T(),
                se(
                  j,
                  ye(
                    { key: 0, class: e.labelColCls, style: e.mergedLabelStyle },
                    e.mergedLabelCol,
                  ),
                  {
                    default: d(() => [
      ...
      const t = rt(),
          ...
          const r = [
            {
              label: "编辑",
              key: "edit",
              icon: () => ne(ee, null, { default: () => ne(He) }),
            },
            {
              label: "复制Token",
              key: "copy",
              icon: () => ne(ee, null, { default: () => ne(Zt) }),
            },
          ];
          return (
        ...
        l = (u, r) => {
          if (j(u) === "connected")
            ...
            try {
              (o.createWebSocketConnection(u, r.token, r.wsUrl),
              ...
              try {
                ...
                if (
                  ...
                  try {
                    ...
                    throw new Error(
                      `跨域请求被阻止。请确保目标服务器支持CORS。错误详情: ${k.message}`,
                    );
                  }
                if (!w.ok)
                  throw new Error(`请求失败: ${w.status} ${w.statusText}`);
                ...
                (console.error("重新获取Token失败:", b),
                  t.error(b.message || "Token重新获取失败"));
              }
            },
          });
        },
...
源地址：${r.sourceUrl}`,
            ...
            onPositiveClick: async () => {
              try {
                ...
                (console.error("URL刷新Token失败:", b),
                  t.error("刷新失败: " + b.message));
              }
            },
          });
        },
          ...
          ((r.onload = (b) => {
            try {
              const w = JSON.parse(b.target.result),
                C = o.importTokens(w);
              C.success
                ? (t.success(C.message), s.fetchGameRoles())
                : t.error(C.message);
            } catch {
              t.error("导入失败：文件格式错误");
            }
              ...
              extra: d(() => [
                c("div", Ko, [
                  p(
                    ...
                    {
                      icon: d(() => [
                        p(A(ee), null, { default: d(() => [p(A(Be))]), _: 1 }),
                      ]),
                      default: d(() => [
                        r[0] ||
                          (r[0] = c("span", { class: "btn-text" }, "刷新", -1)),
                      ]),
                      _: 1,
                    },
                    8,
                  ...
                  p(
                    ...
                    },
                    {
                      icon: d(() => [
                        ...(r[1] ||
                          (r[1] = [
                            c("i", { class: "i-mdi:download" }, null, -1),
                          ])),
                      ]),
                      default: d(() => [
                        r[2] ||
                          (r[2] = c("span", { class: "btn-text" }, "导出", -1)),
                      ]),
                      _: 1,
                    },
                    8,
                    ...
                    c("h4", tn, [
                      ...
                      p(
                        C,
                        {
                          size: "small",
                          type: "info",
                          class: "token-count-tag",
                        },
                        {
                          default: d(() => [
                            E(
                              I(Object.keys(A(o).gameTokens).length) + "个 ",
                              1,
                            ),
                          ]),
                          _: 1,
