import { _ as b, T as f, g as m, s as y, a as w } from "./index-CBMhjSrw.js";
import {
  k as S,
  d as V,
  e as h,
...
const j = S({
  ...
  setup(o, { emit: t }) {
    const e = m("tooltip"),
      ...
      p = (n) => {
        ((a.value = n),
          t("update:popupVisible", n),
          t("popupVisibleChange", n));
      },
      ...
      C = r(() => {
        if (o.backgroundColor || o.arrowStyle)
          return { backgroundColor: o.backgroundColor, ...o.arrowStyle };
      });
    return {
      prefixCls: e,
...
function O(o, t, e, a, l, p) {
  ...
  return (
    ...
    h(
      ...
      {
        content: u(() => [
          c(o.$slots, "content", {}, () => [P(k(o.content), 1)]),
        ]),
